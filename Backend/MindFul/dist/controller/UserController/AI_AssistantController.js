import { generateAIResponse, isMindfulnessRelated, getJournalEntriesFromDB, saveAIConversation, } from '../../services/AIService.js';
// ============================================================
// CHAT WITH AI
// ============================================================
export const chatWithAI = async (req, res) => {
    try {
        ...
        if (!entries || entries.length === 0) {
            const noEntriesMsg = "I can't analyze your wellness yet. Please enter a Daily Journal entry first";
        ...
        if (!isRelevant) {
            const notRelevantMsg = "Sorry, I can only help with mindfulness, mood, stress, sleep, energy, journaling, and mental wellness. Please ask something related to your wellness journey";
            // Save the exchange
...
//# sourceMappingURL=AI_AssistantController.js.map